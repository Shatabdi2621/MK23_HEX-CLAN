    ...
    return FutureBuilder<File>(
      ...
      builder: (BuildContext context, AsyncSnapshot<File> snapshot) {
        if (snapshot.connectionState == ConnectionState.done &&
          ...
          return const Text(
            'No image',
            style: TextStyle(fontFamily: 'Open Sans', fontWeight: FontWeight.bold, fontSize: 20.0),
            textAlign: TextAlign.center,
          );
        }
      },
            ...
            Padding(
              ...
              child: RaisedButton(
                ...
                child: Container(
                  ...
                  height: 60.0,
                  width: 250.0,
                  child: Text('Take a picture', style: TextStyle(fontSize: 22.0,fontFamily: 'Open Sans'),)),
              ),
            ),
            SizedBox(
              height: 50.0,
            ...
            Padding(
              ...
              child: RaisedButton(
                ...
                child: Container(
                  ...
                  height: 60.0,
                  width: 250.0,
                  child: Text('Proceed to dashboard', style: TextStyle(fontSize: 22.0,fontFamily: 'Open Sans'),)),
              ),
            ),
            SizedBox(
              height: 20.0,
