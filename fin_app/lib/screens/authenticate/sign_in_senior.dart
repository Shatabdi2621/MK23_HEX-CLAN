import 'package:fin_app/screens/authenticate/upload.dart';
...
class _LoginSeniorUserState extends State<LoginSeniorUser> {
  ...
  Future userLogin() async {
    ...
    if (widget.choice == 'Banking') {
      url = 'https://puppyish-ribbon.000webhostapp.com/senior_official_login.php';
    } else if (widget.choice == 'Insurance') {
      url = 'https://puppyish-ribbon.000webhostapp.com/senior_official_login_insurance.php';
    } else if (widget.choice == 'Pansion') {
      url = 'https://puppyish-ribbon.000webhostapp.com/senior_official_login_pansion.php';
    }
    var data = {
      'userid': userid,
      'password': password,
    ...
    if (message == 'Login Matched') {
      ...
      Route route = MaterialPageRoute(builder: (context) => UploadImageDemo(
