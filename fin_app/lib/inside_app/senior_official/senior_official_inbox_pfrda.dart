...
class NewPFRDA extends StatefulWidget {
  final String userid, choice, sector;
  NewPFRDA({this.userid, this.choice, this.sector});
  @override
  _NewPFRDAState createState() => _NewPFRDAState();
}

class _NewPFRDAState extends State<NewPFRDA> {
  Future<List<Info>> downloadJSON() async {
    final jsonEndpoint =
        "https://puppyish-ribbon.000webhostapp.com/senior_official_inbox_pfrda.php";
