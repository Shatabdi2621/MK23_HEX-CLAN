...
class Info {
  final String id;
  final String heading, body, sector, answer, short, timestamp, question;
...
class QueryManual extends StatefulWidget {
  final String userid, choice, sector;
  QueryManual({this.userid, this.choice, this.sector});
  @override
  _QueryManualState createState() => _QueryManualState();
}

class _QueryManualState extends State<QueryManual> {

  Future<List<Info>> downloadJSON() async {
  final jsonEndpoint = "https://puppyish-ribbon.000webhostapp.com/retreive_query_senior_official.php";
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(
      ...
      home: new Scaffold(
        appBar: AppBar(centerTitle: true, title: Text('Queries', style: TextStyle(color: Colors.black, fontFamily: 'Open Sans', fontWeight: FontWeight.bold),),backgroundColor: Colors.cyan[100],),
        body: new Center(
