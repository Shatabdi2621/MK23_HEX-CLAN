...
class _SecondScreenState extends State<SecondScreen> {
  ...
  Future sendmailCircular() async {
    ...
    var url = 'https://puppyish-ribbon.000webhostapp.com/register_user.php';
...
class _SaveState extends State<Save> {
  ...
  final jsonEndpoint = "https://puppyish-ribbon.000webhostapp.com/save_retreive.php";
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(
      ...
      home: new Scaffold(
        appBar: AppBar(centerTitle: true, title: Text('Saved Circulars', style: TextStyle(color: Colors.black, fontFamily: 'Open Sans', fontWeight: FontWeight.bold),),backgroundColor: Colors.cyan[100],),
        body: new Center(
