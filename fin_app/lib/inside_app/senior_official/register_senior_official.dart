...
void main() => runApp(RegisterSeniorOfficial());

class RegisterSeniorOfficial extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return MaterialApp(
        debugShowCheckedModeBanner: false,
        home: Scaffold(
            appBar: AppBar(title: Text('Registration Form', style: TextStyle(color: Colors.black, fontFamily: 'Open Sans', fontSize: 20.0, fontWeight: FontWeight.bold)), backgroundColor: Colors.cyan[100],),
...
class RegisterUserState extends State {
  ...
  Future userRegistration() async {
    ...
    var url =
        'https://puppyish-ribbon.000webhostapp.com/register_senior_official.php';
