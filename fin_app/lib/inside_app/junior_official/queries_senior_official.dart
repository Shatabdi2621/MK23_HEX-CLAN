...
class Info {
  final String id;
  final String heading, body, answer, short, timestamp, question;
...
class QuerySeniorOfficial extends StatefulWidget {
  final String userid, choice, sector;
  QuerySeniorOfficial({this.userid, this.choice, this.sector});
  @override
  _QuerySeniorOfficialState createState() => _QuerySeniorOfficialState();
}

class _QuerySeniorOfficialState extends State<QuerySeniorOfficial> {

  Future<List<Info>> downloadJSON() async {
  final jsonEndpoint = "https://puppyish-ribbon.000webhostapp.com/retreive_query_junior_official_from_senior_official.php";
