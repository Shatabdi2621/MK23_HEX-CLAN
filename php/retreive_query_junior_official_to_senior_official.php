...
class Info
{
    ...
    $userid = $obj['userid'];
            ...
            $SQL_SELECT_ALL = "SELECT * FROM queries WHERE senior_official_user_id = '$userid'";
            ...
            if(isset($result->num_rows) && $result->num_rows >0)
            {
                ...
                while($row=$result->fetch_array())
                {
                    ...
                    "body"=>$row['body'],"sector"=>$row['sector'],"answer"=>$row['answer'],"timestamp"=>$row['timestamp'],"random_number"=>$row['random_number']
                    ));
                }
