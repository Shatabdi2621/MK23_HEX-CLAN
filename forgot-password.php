...
<html lang="en">
	<head>
		<title>Junior official  Password Recovery</title>
	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../index.html"><h2> F.I.U | Junior official Password Recovery</h2></a>
				</div>
				...
				<div class="box-login">
					<form class="form-login" method="post">
						<fieldset>
							<legend>
								Junior offcial Password Recovery
							</legend>
							<p>
					...
					<div class="copyright">
						&copy; <span class="current-year"></span><span class="text-bold text-uppercase"> FIU</span>. <span>All rights reserved</span>
					</div>
